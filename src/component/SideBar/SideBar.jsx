    ...
    return (
        <div className={styles.sideBar}>
            ...
            <div className={styles.sideBarOptionsBlock}>
                ...
                <Link to={'/dashboard'} className={[styles.sideBarOption, location.pathname === '/dashboard' ? styles.selectedOption : ''].join(' ')}>
                    <DashboardIcon sx={{ fontSize: 22 }} />
                    <div>Dashboard</div>
                </Link>

                <Link to={'/history'} className={[styles.sideBarOption, location.pathname === '/history' ? styles.selectedOption : ''].join(' ')}>
                    <ManageSearchIcon sx={{ fontSize: 28 }} />
                    <div>History</div>
                </Link>

                {
                    userInfo?.role === 'admin' && <Link to={'/admin'} className={[styles.sideBarOption, location.pathname === '/admin' ? styles.selectedOption : ''].join(' ')}>
